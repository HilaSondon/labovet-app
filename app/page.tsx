  ...
  return (
    <main className="workspace">
      <header className="workspace-bar">
        ...
        <div className="user-menu"><span><b>{profile.name || user.displayName || "Usuario"}</b><small>{isAdmin ? "Administrador" : "Veterinario"}</small></span><button onClick={() => signOut(auth)}>Salir</button></div>
      </header>
      {view === "admin" && isAdmin
        ? <section className="admin-page"><AdminUsersPanel currentUid={user.uid} /></section>
        : <iframe className="sigatm-frame" src="/sigatm/index.html?embedded=1" title="LabOVet Planillas SIGATM" />}
    </main>
  );
}
  ...
  return (
    <main className="public-site">
      ...
      <section className="hero" id="inicio">
        <div className="hero-copy"><span className="kicker">PLANILLAS LISTAS PARA SIGATM</span><h1>De Excel a SIGATM <em>en segundos.</em></h1><p>Transformá listados de Excel, mensajes de WhatsApp o datos escritos a mano en una planilla compatible con SIGATM, sin acomodar columnas ni memorizar códigos.</p><div className="hero-actions"><button onClick={() => setAuthMode("register")}>Preparar una planilla <span>→</span></button><a href="#como-funciona">Ver cómo funciona</a></div><div className="trust-row"><span>✓ Validación previa</span><span>✓ Carga inteligente</span><span>✓ Información privada</span></div></div>
        <div className="hero-preview"><div className="preview-top"><span>LABOVET · PLANILLAS SIGATM</span><i>Archivo listo</i></div><div className="preview-title"><small>NUEVA PLANILLA</small><h2>Pegá, revisá y descargá.</h2></div><div className="preview-jobs"><article><span>🐴</span><b>Anemia equina</b><small>Identificación variable</small></article><article className="selected"><span>🐄</span><b>Brucelosis bovina</b><small>Caravana · bovinos</small></article><article><span>🐔</span><b>Aves</b><small>Identificación opcional</small></article></div><div className="preview-data"><span>032105465213</span><b>VACA</b><i>✓</i></div><div className="preview-data"><span>70264-2</span><b>VAQUILLONA</b><i>✓</i></div><button onClick={() => setAuthMode("register")}>Descargar Excel SIGATM ↓</button></div>
      </section>

      <section className="how" id="como-funciona"><div className="section-heading"><span className="kicker">CÓMO FUNCIONA</span><h2>Una carga simple, aunque los datos lleguen desordenados.</h2><p>Elegís el trabajo y LabOVet configura los valores habituales. Solo corregís lo que la validación marque y descargás el archivo con los códigos requeridos.</p></div><div className="step-grid"><article><b>1</b><h3>Pegá o escribí</h3><p>Copiá columnas de Excel, pegá el detalle recibido por WhatsApp o cargá unas pocas muestras manualmente.</p></article><article><b>2</b><h3>Revisá antes de cargar</h3><p>Aplicá categoría, edad o estado a todo el lote y detectá datos faltantes, repetidos o inválidos.</p></article><article><b>3</b><h3>Descargá y subí</h3><p>Elegí el nombre del archivo y seguí el instructivo visual para incorporarlo correctamente a SIGATM.</p></article></div></section>

      <section className="scope" id="rubros"><div className="scope-copy"><span className="kicker">RUBROS CONTEMPLADOS</span><h2>Preparado para el trabajo veterinario habitual.</h2><p>La herramienta adapta especie, identificación, categoría y edad según el análisis. Después podés cambiar cualquier dato si el caso lo requiere.</p></div><div className="scope-list"><article><span>🐴</span><div><b>Equinos</b><p>Anemia infecciosa equina</p></div></article><article><span>🐄</span><div><b>Bovinos</b><p>Brucelosis y leucosis</p></div></article><article><span>🐑</span><div><b>Ovinos</b><p>Brucella ovis</p></div></article><article><span>🐖</span><div><b>Porcinos</b><p>Aujeszky y triquina</p></div></article><article><span>🐔</span><div><b>Aves</b><p>Categorías e identificación opcional</p></div></article></div></section>

      <section className="support"><div className="support-icon">↻</div><div><span>ACOMPAÑAMIENTO</span><h2>La herramienta evoluciona junto con SIGATM.</h2><p>Nos mantenemos en constante asesoramiento sobre los cambios que pueda incorporar SIGATM para actualizar el estandarizador y ayudarte ante cualquier duda.</p></div><aside><small>LÍNEA DIRECTA</small><a href="tel:2244429316">2244-429316</a><span>Correo de consultas: próximamente</span></aside></section>
