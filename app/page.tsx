...
function MarketingHome({ page }: { page: "general" | "laboratories" | "about" }) {
  ...
  return <main className="landing-site">
    ...
    {page === "general" ? <>
      ...
      <section className="landing-detail-body landing-section" id="como-funciona"><span>CÓMO FUNCIONA</span><h2>Del acta recibida al informe listo.</h2><p>VetConver toma los datos del acta y prepara el protocolo para que revises la información antes de descargar los archivos.</p><div className="landing-feature-grid"><article><b>01 · CARGÁ</b><h3>Seleccioná el acta PDF</h3><p>La herramienta interpreta las muestras y los datos del acta para iniciar el protocolo.</p></article><article><b>02 · REVISÁ</b><h3>Completá los resultados</h3><p>Verificá los datos interpretados, cargá los resultados y ajustá lo necesario para cada muestra.</p></article><article><b>03 · DESCARGÁ</b><h3>Continuá tu trabajo</h3><p>Obtené el JSON para GRECERT y los informes detallados en PDF y Excel.</p></article></div><p className="landing-note">La revisión del laboratorio sigue siendo necesaria antes de utilizar los archivos generados.</p></section>
